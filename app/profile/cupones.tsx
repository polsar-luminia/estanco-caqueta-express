      ...
      >
        {isError ? (
          <View className="items-center py-16">
            ...
            <Text style={{ fontSize: 16, fontFamily: fuentes.destacado, color: colors.muted, marginTop: 12 }}>No pudimos cargar los cupones</Text>
            <Pressable
              onPress={() => refetch()}
              hitSlop={6}
          ...
          <>
            {activos.length > 0 && (
              <>
                <Text style={{ fontSize: 12, fontFamily: fuentes.destacado, color: colors.faint, textTransform: "uppercase", letterSpacing: 2 }}>
            ...
            {usados.length > 0 && (
              <>
                <Text style={{ fontSize: 12, fontFamily: fuentes.destacado, color: colors.faint, textTransform: "uppercase", letterSpacing: 2, marginTop: 8 }}>
        ...
        <View style={{ flex: 1, padding: 16 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: colors.lowfill, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, gap: 8 }}>
              <Text style={{ fontSize: 15, fontFamily: fuentes.destacado, color: colors.ink, letterSpacing: 2, fontVariant: ["tabular-nums"] }}>
                {cupon.codigo}
              </Text>
              {!usado && (
                <Pressable
            ...
            <View style={{ backgroundColor: usado ? colors.lowfill : "rgba(240,101,63,0.1)", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 }}>
              <Text style={{ fontSize: 14, fontFamily: fuentes.destacado, color: usado ? colors.faint : colors.offer }}>
                {getCuponLabel(cupon)}
              </Text>
            </View>
          </View>
